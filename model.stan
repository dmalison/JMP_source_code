...

{
    ...
    matrix[N,3] epsilon_3 = epsilon_3_ * L_corr_3' * diag_matrix(sigma_3);
  ...
  /*** assign theta_4 ***/
  {
    ...
    epsilon_3[R_3_ind0,1] = rep_vector(0,R_3_N0);
...
/*** priors ***/
  ...
  gamma_4_11_ ~ gamma(2,2);
  gamma_4_22_ ~ gamma(2,2);
  gamma_4_33_ ~ gamma(2,2);
...
/*** state variables ***/
  ...
  to_vector(epsilon_3_) ~ normal(0,1);
