...
parNames = c("gamma_M_R_4_cat3", "c_M_R_4_cat3", "gamma_M_R_4_cat5", "c_M_R_4_cat5")
...
save(list = c("stan_data", "fit_stan", "parNames"), file = "~/bin/JMP/work/fit_M_R_4")
